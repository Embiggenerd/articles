...
// PrettyHandler is a custom slog.Handler that is a slight modification of the
// slog.TextHandler from slog. It is used to log messages to the console in a pretty format.
